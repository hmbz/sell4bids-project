//
//  ViewOffers_ViewOrders_Services.swift
//  Sell4Bids
//
...
class ViewOffers_ViewOrders_Services: UIViewController , SwipeMenuViewDelegate , SwipeMenuViewDataSource,UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let storyboardv = UIStoryboard.init(name: "ServiceDetail", bundle: Bundle.main)
        let controller1 = storyboardv.instantiateViewController(withIdentifier: "Offer_View_Identifier") as! Services_ViewOffers
        ...
        let controller2 = storyboardv.instantiateViewController(withIdentifier: "OrderView_Service") as! Services_ViewOrders
        controller2.navi = self.nav
        controller2.title = "Orders"
        controller2.ServiceDetails = selectedProduct!
