...
class VehiclesOrders: UIViewController ,UITableViewDelegate , UITableViewDataSource, UIGestureRecognizerDelegate {
...
//        self.navigationController?.pushViewController(controller, animated: true)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if ordersArray[indexPath.row].order_status == "Completed" {
            ...
            cell.priceLbl.textColor = #colorLiteral(red: 0.7450980544, green: 0.1568627506, blue: 0.07450980693, alpha: 1)
            ...
            cell.ItemQuantity_Price.text = "Completed"
            cell.ItemQuantity_Price.textColor = UIColor.blue
            ...
            cell.actualNameLbl.text = "Buyer's Order"
            cell.priceLbl.text = "$\(ordersArray[indexPath.row].price)"
            cell.priceLbl.textColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
    ...
    func ReloadOrderData() {
        ...
        MainApi.Get_Orders(seller_uid: SessionManager.shared.userId, item_id: self.VehiclesDetails!.id, type: "orders", sellerImage: SessionManager.shared.image , start: "0" , limit: "25") { (status, data, error) in
            ...
            if status {
                ...
                if message1.contains("No Orders available on this item") {
                    
                    _ = SweetAlert().showAlert("Orders", subTitle: message1, style: .error)
