...
open class SweetAlert: UIViewController {
    ...
    open func showAlert(_ title: String, subTitle: String?, style: AlertStyle) -> SweetAlert {
        ...
        _ = showAlert(title, subTitle: subTitle, style: style, buttonTitle: "Ok".localizableString(loc: LanguageChangeCode))
    ...
    open func showAlert(_ title: String, subTitle: String?, style: AlertStyle,buttonTitle: String,buttonColor: UIColor,action: ((_ isOtherButton: Bool) -> Void)? = nil) {
