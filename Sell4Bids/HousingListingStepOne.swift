...
class HousingListingStepOne: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UITextViewDelegate,getImageDelegate {
    ...
    //MARK:- Variables
    let CategoryArray = ["Any","Apartment for rent","Apartment for sale","House for rent","Housing Wanted","Rooms & Shared","Rooms Wanted","Office & Commercial","Parking & Storage", "Sublets & Temporary"]
    var limitcount = 0
    ...
    override func viewDidLoad() {
        ...
        SelectCategoryName.textAlignment = .center
    }
