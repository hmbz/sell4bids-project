...
class Services_ViewOrders: UIViewController ,UITableViewDelegate , UITableViewDataSource, UIGestureRecognizerDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if ordersArray[indexPath.row].order_status == "Completed" {
            ...
            cell.ItemQuantity_Price.textColor = colorBlue
            ...
            cell.ItemQuantity_Price.text = "  Pending  "
            cell.ItemQuantity_Price.backgroundColor = #colorLiteral(red: 0.1764705926, green: 0.4980392158, blue: 0.7568627596, alpha: 1)
            cell.locationtxt.text = ordersArray[indexPath.row].address
            ...
            cell.ItemQuantity_Price.text = "  Pending  "
            cell.ItemQuantity_Price.backgroundColor = #colorLiteral(red: 0.2745098174, green: 0.4862745106, blue: 0.1411764771, alpha: 1)
            ...
            cell.ItemQuantity_Price.backgroundColor = UIColor.red
            cell.BuyerName.text = ordersArray[indexPath.row].name
        ...
        cell.ItemQuantity_Price.textColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
    ...
    var ServiceDetails : sellingModel?
    ...
    func ReloadOrderData() {
        ...
        MainApi.Get_Orders(seller_uid: SessionManager.shared.userId, item_id: self.ServiceDetails!.id, type: "orders", sellerImage: SessionManager.shared.image , start: "0" , limit: "50") { (status, data, error) in
            
            let message = data!["message"]
            
            if status {
                
                let message1 = data!["data"].stringValue
                
                if message1.contains("No orders received for this service.") {
                    _ = SweetAlert().showAlert("Orders", subTitle: message1, style: .error,buttonTitle:"Ok".localizableString(loc: LanguageChangeCode), buttonColor:UIColor.colorFromRGB(0x000000))
                }else {
