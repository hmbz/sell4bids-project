...
open class GooglePlacesSearchController: UISearchController, UISearchBarDelegate {
    ...
    convenience public init(delegate: GooglePlacesAutocompleteViewControllerDelegate, apiKey: String, placeType: PlaceType = .all, coordinate: CLLocationCoordinate2D = kCLLocationCoordinate2DInvalid, radius: CLLocationDistance = 0, strictBounds: Bool = true, searchBarPlaceholder: String = "Enter Address") {
