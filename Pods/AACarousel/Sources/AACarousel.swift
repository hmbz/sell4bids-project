...
public class AACarousel: UIView,UIScrollViewDelegate {
    ...
    fileprivate func initWithImageView() {
        ...
        beforeImageView.frame = CGRect(x: 0, y: 0, width: UIScreen.main.bounds.width, height: 200)
        currentImageView.frame = CGRect(x: 0, y: 0, width: UIScreen.main.bounds.width, height: 200)
        afterImageView.frame = CGRect(x: 0, y: 0, width: UIScreen.main.bounds.width, height: 200)
